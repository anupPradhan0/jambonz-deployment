...
const testData: Array<{ input: string; expectedOutput: boolean; description: string }> = [
  ...
  {
    input: '991240413047.primary.companyflex.de:0',
    expectedOutput: false,
    description: 'Hostname with port, not IP'
  }
];
